...
| **MEM-04** | Personal Branding | Uso de clichés de IA ("delve", "testament") o afirmaciones sin métricas | Activación obligatoria de `humanizer` y justificación cuantitativa de cada logro técnico. | [01_ats_optimization.md](memory/01_ats_optimization.md) |
