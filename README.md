...
| :--- | :--- | :--- | :--- | :--- |
| [**`01_Template_Mobile_Flutter`**](./01_Template_Mobile_Flutter) | Flutter 3.5+, Riverpod 3.x, Android API 34–37, Firebase | `firebase`, `google_maps_platform`, `flutter/dart`, `github` | `pocock-safety`, `ponytail (YAGNI)`, `karpathy-discipline (Urgency Bypass)` | Decoupled Manifest (`project_manifest.json`), Domain Router RAG, Lifecycle Skills, Bucle 360°, Clean Architecture |
...
| [**`03_Template_Career_HR`**](./03_Template_Career_HR) | Playwright Headless PDF, ATS Parser, Python, LinkedIn Sync | `playwright/python`, `web-search/url-reader`, `github` | `anthropic-skills`, `marketingskills`, `humanizer`, `cv-ats-optimizer`, `cognitive-doc-design` | Decoupled Manifest (`project_manifest.json`), Domain Router RAG, Lifecycle Skills, Deterministic 2-page A4 PDF rendering, strict NDA compliance, 360° Profile Synchronization |
